                ...
                <TD height=27 background=sechandmall_files/tn.jpg>
                  <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                    ...
                    <TR>
                      ...
                      <TD class=green_title01>求购信息</TD>
                      <TD width=50>
                        ...
                        bgColor=#dddddd>
                          ...
                          <TR>
                            <TD valign="top" bgColor=#ffffff>
                             ...
                             PageManager pageManager = PageManager.getPage("qmore.jsp?1=1", 18, request);
							  pageManager.doList("select * from minfo where infotype='求购' order by id desc");
