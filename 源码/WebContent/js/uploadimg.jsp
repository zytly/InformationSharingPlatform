...
<LINK 
href="/sechandmall/admin/images/syscome.files/Admin.css" rel=stylesheet>
<SCRIPT language=javascript src="/sechandmall/admin/images/syscome.files/Admin.js"></SCRIPT>
...
if(filename!=null)
{
 ...
 txt.src="/sechandmall/upfile/<%=filename%>";
 popclose();
 </script>
 <%} %>
<form action="/sechandmall/sechandmall?ac=uploadimg" enctype="multipart/form-data" name="f1" method="post">
...
if(suc!=null)
{
 %>
 alert("操作成功");
  parent.location.replace("/sechandmall/admin/kcfiles.jsp");
 <%}%>
 </script>
