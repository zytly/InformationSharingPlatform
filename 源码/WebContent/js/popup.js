...
function uploadimg()
{
pop("/sechandmall/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/sechandmall/js/uploadimg2.jsp","上传图片",300,77)
}

function uploaddoc()
{
pop("/sechandmall/js/uploaddoc.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/sechandmall/js/dialogclose.gif  />';
